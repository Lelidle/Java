...
public class BinaryTree {
    ...
    /**
     * Constructor for the binary tree, initializes an empty tree with an EndNode as root.
     */
    public BinaryTree(){
        root = new EndNode();
    }
    ...
    public void setRoot(DataElement data) {
        if(root instanceof EndNode) root = new DataNode(data);
    }
     ...
     * @param order the order in which the tree will be printed, given by the Enum Order.
     */
